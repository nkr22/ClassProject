    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empl_record', models.CharField(blank=True, max_length=1, null=True)),
        ...
        migrations.CreateModel(
            name='Students',
            fields=[
                ('id', models.OneToOneField(db_column='id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='newapp.person')),
                ('byu_first_name', models.CharField(blank=True, max_length=45, null=True)),
                ('byu_last_name', models.CharField(blank=True, max_length=45, null=True)),
                ('international', models.IntegerField(blank=True, null=True)),
                ('phone', models.CharField(blank=True, max_length=20, null=True)),
